...
from matrices import matrices_H_f, matrices_H_f_deg2, matrices_H_f_deg2_not_pseudo
...
def solve_for_alpha_deg2(centreline: Centreline):
    P, q = matrices_H_f_deg2(centreline)
...
def solve_for_alpha_deg2_not_pseudo(centreline: Centreline):
    P, q = matrices_H_f_deg2_not_pseudo(centreline)
